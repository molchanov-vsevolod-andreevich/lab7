...
Типы команд хранятся в числовом виде, поэтому для них есть функция prettyPrinting(), которая вместо числа выводит название команды. В выводах программ я печатаю 
